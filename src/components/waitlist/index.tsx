        ...
        <Box bg='brand.200' py='100px'>
            <ContainLayout>
                <VStack alignItems='center' justifyContent='center' gap='30px' color='white'>
                    <Text fontSize='24px' fontWeight='500' maxW='530px' textAlign='center' >Join the waitlist to gain early access and receive newsletters about upcoming updates.</Text>
